...
import { NUMBER_SUPPORT } from "../../config/env";
...
const Connections = () => {
  ...
  const [facebookModalChannel, setFacebookModalChannel] = useState("facebook");
  ...
  const handleOpenFacebookModal = (channel) => {
    setFacebookModalChannel(channel);
                        ...
                        <>
                          ...
                          <Menu {...bindMenu(popupState)}>
                            ...
                            <MenuItem
                              ...
                              onClick={() => {
                                handleOpenFacebookModal("facebook");
                                popupState.close();
                              }}
                            >
                              <Facebook
                            ...
                            <MenuItem
                              ...
                              onClick={() => {
                                handleOpenFacebookModal("instagram");
                                popupState.close();
                              }}
                            >
                              <Instagram
