...
const ListMessagesService = async ({
  ...
  const { count, rows: messages } = await Message.findAndCountAll({
    ...
    attributes: ["id", "fromMe", "mediaUrl", "body", "mediaType", "ack", "createdAt", "ticketId", "isDeleted", "queueId", "isForwarded", "isEdited", "isPrivate", "companyId", "translatedBody", "originalLanguage", "transcription"],
    limit,
    include: [
      {
        model: Contact,
